	...
	<div id="home" class="header">
		<div class="top-header">
			<div class="container">
				...
				<div class="top-nav">
					<ul>
					<li class="active"><a class="play-icon popup-with-zoom-anim" href="Logout.jsp" onclick="alert('Are you sure to logout?')">LOGOUT</a></li>	
					</ul>
				</div>
		...
		<div class="navgation">
			<div class="menu">
				...
				<li><a href="viewcurrentbid"><button id="b" type="submit" class="btn btn-primary"style="align-items: center" width="50%">View Current Bid</button></a></li>
